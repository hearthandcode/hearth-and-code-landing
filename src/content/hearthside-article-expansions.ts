export interface HearthsideArticleExpansionSection {
  heading: string;
  paragraphs: string[];
}

export const hearthsideArticleExpansions: Record<string, HearthsideArticleExpansionSection[]> = {
  'meaning-before-machinery': [
    {
      heading: 'Where this principle meets my actual work',
      paragraphs: [
    ...
    {
      heading: 'A seam across the studio',
      paragraphs: [
    ...
    {
      heading: 'The danger of a beautiful total system',
      paragraphs: [
    ...
    {
      heading: 'A Hearthside test for new machinery',
      paragraphs: [
  ...
  'uncertainty-is-a-room': [
    {
      heading: 'My uncertainty has several temperatures',
      paragraphs: [
    ...
    {
      heading: 'The dashboard temptation',
      paragraphs: [
    ...
    {
      heading: 'How I keep a question alive across projects',
      paragraphs: [
    ...
    {
      heading: 'What visible uncertainty owes the reader',
      paragraphs: [
  ...
  'a-humane-theory-of-provenance': [
    {
      heading: 'Why I keep building trails',
      paragraphs: [
    ...
    {
      heading: 'Private roots and public branches',
      paragraphs: [
    ...
    {
      heading: 'Provenance as creative material',
      paragraphs: [
    ...
    {
      heading: 'A letter to the future maintainer',
      paragraphs: [
  ...
  'tools-in-a-bounded-room': [
    {
      heading: 'Why I need bounded agents',
      paragraphs: [
    ...
    {
      heading: 'A room can have windows without losing its walls',
      paragraphs: [
    ...
    {
      heading: 'When the tool should stop',
      paragraphs: [
    ...
    {
      heading: 'The hearth is the point of return',
      paragraphs: [
    ...
    {
      heading: 'A field protocol for one bounded task',
      paragraphs: [
  ...
  'typed-context-for-real-work': [
    {
      heading: 'What typed context solved for me',
      paragraphs: [
    ...
    {
      heading: 'From prompt to service surface',
      paragraphs: [
    ...
    {
      heading: 'When types become theatre',
      paragraphs: [
    ...
    {
      heading: 'A worked packet from my bench',
      paragraphs: [
    ...
    {
      heading: 'What TCCP remains for me',
      paragraphs: [
  ...
  'knowledge-representation-without-a-black-box': [
    {
      heading: 'The knowledge system I am actually trying to build',
      paragraphs: [
    ...
    {
      heading: 'A bilingual surface for people and machines',
      paragraphs: [
    ...
    {
      heading: 'Identity across change',
      paragraphs: [
    ...
    {
      heading: 'Readable failure is part of the representation',
      paragraphs: [
    ...
    {
      heading: 'The public proof I would trust',
      paragraphs: [
  ...
  'operational-intelligence-as-comparison-practice': [
    {
      heading: 'Why comparison became a research practice',
      paragraphs: [
    ...
    {
      heading: 'Cross-system work without a master system',
      paragraphs: [
    ...
    {
      heading: 'The non-sovereign dashboard',
      paragraphs: [
    ...
    {
      heading: 'Failure modes I use as counterweights',
      paragraphs: [
    ...
    {
      heading: 'What I want to measure next',
      paragraphs: [
  ...
  'prompting-as-interface-design': [
    {
      heading: 'How prompting grew into architecture for me',
      paragraphs: [
    ...
    {
      heading: 'Different prompts should make different rooms',
      paragraphs: [
    ...
    {
      heading: 'The repair burden is an interface metric',
      paragraphs: [
    ...
    {
      heading: 'Prompt systems can become too much system',
      paragraphs: [
    ...
    {
      heading: 'My personal prompt review',
      paragraphs: [
